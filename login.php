...
<body>
	...
	<div>
		<div class="form" id="login">
			<h4 style="background-color: #438cf1;"><b>LET'S PREDICT YOUR COLLEGE ! </b></h4>
			<div class="box">
				<h3>LOGIN</h3>
				...
				<form action="login.php" method="POST">
					...
					<a id="oksignup"><b>New User ? Sign Up here</b></a>
				</form>
			</div>
		</div>
		<div class="form reg" id="signup">
			...
			<div class="box">
				...
				<form action="login.php" method="POST">
					...
					<a id="oklogin"><b>Have an account? Login Here</b></a>
				</form>
			</div>
		</div>
	</div>
