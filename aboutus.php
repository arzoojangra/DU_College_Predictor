...
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
    	...
    	<img src="logo.png" width="30" height="30" class="d-inline-block align-top" alt=""> College Predictor
  		</a>
  <!-- Links -->
	...
	<div class="background">
		<h2>About Us</h2>
		<p> College Predictor is a Web Application to help 12th grade students wanting to pursue UG under University of Delhi to know the colleges they can enroll. </p>
	</div>
